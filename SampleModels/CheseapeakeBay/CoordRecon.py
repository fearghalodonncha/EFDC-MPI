...
def main():
    # this module processes the Codar file from raw lon/lat coordinates to the EFDC grid
    # for convenience in this case it is done offline
    #    map_codar_to_efdc()
