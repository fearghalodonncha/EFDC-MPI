      ...
      DO L=2,LA  
        ...
        IF(DXXTMP.LT.0.OR.DXXTMP.GT.DMAX)THEN  
          ...
          IF(SUB(L).NE.0)THEN  
            ...
            ENDIF  
          ENDIF  
          IF(SUB(LEAST(L)).NE.0)THEN  
            DXXEAST=DXXTCA(LEAST(L))  
