...
C  
      ...
      ALLOCATE(CSER(NDCSER,KCM,NCSERM2,NSTVM))  
...
! Declare Variables related to Deep thunder coupling
      ...
      !Allocate Makai DA variables
          ...
          ALLOCATE(TUVSER(1000,NUVSER))
          ALLOCATE(USER(1000,KCM,NUVSER),VSER(1000,KCM,NUVSER)) !1000 is arbitrarily large as I was lazy and assuming that MUVSER(NS)<=1000 in UVSER.INP
