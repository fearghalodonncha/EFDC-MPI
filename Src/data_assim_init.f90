...
SUBROUTINE DA_INI
    ...
    CODPRE = "Codar_chesapeake_"    ! File prefix for the preprocessed HFR files
    ...
    IF (IDA_FLAG == 1) THEN
        ...
        DATESTRING = YEAR //'_'// MONTH // '_' // DAY //'_'// HOUR // MINUTE  ! DATESTRING OF FORM YYYY_MM_DDHHMM
        CODARNAME = trim(CODPRE) // trim(DATESTRING) // '.csv'
        writE(*,*) codarname, trim(datestring)
        ...
        VNU3D='HFRFiles/'//TRIM(CODARNAME)   ! a sample data assimilation observation file
