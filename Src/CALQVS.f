      ...
      IF(N.EQ.1)THEN  
        DO LL=1,NQSIJ  
          ...
          IF(ITYP.LE.0.OR.ITYP.GE.8)THEN  
            WRITE(6,6111)LL,IQS(LL),JQS(LL),XPAR(IQS(LL)),YPAR(JQS(LL))
            WRITE(8,6111)LL,IQS(LL),JQS(LL),XPAR(IQS(LL)),YPAR(JQS(LL))
...
C  
 ...
 6111 FORMAT(' INVALID NQSIJ LOCATION, NQSIJ,I,J = ',5I5)  
      RETURN  
      END  
